...
graph output with respect to all input values. However, when doing machine
...
graph to handle many of the standard things we need to do in ML. Once the graph is
constructed, in the sense of constructing the nodes and linking them together,
we can construct a ComputationGraphFunction by passing the nodes in
